...
export class CurrencyService {
  ...
  private toIsoDate(date: Date | string): string {
    if (typeof date === 'string') {
      // `fechaEmision` se persiste como dd/mm/yyyy: cortar a 10 caracteres
      // guardaría "03/08/2026" como si fuera ISO y dejaría un `tcFecha`
      // ilegible para auditar la conversión.
